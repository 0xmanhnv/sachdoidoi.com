...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(asset('admin_assets/css/blue.css')); ?>">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <form action="<?php echo e(asset('admin/login')); ?>" method="post" autocomplete="off" id="login">
          <?php echo csrf_field(); ?>

          <input style="display:none">
          <input type="password" style="display:none">
          <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="Email" name="email" autocomplete="off" value="<?php echo e(old('email')); ?>">
    ...
    <!-- iCheck -->
    <script src="<?php echo e(asset('admin_assets/js/icheck.min.js')); ?>"></script>
    <script>
      $(function () {
        $('input').iCheck({
