						        ...
						        <article class="timeline-entry">
						            ...
						            <div class="timeline-entry-inner">
						                ...
						                <div class="timeline-label">
						                    <h2>
						                    	<a href="<?php echo e(route('blog.post.detail', [$post->slug])); ?>"><?php echo e($post->title); ?></a> 
						                    	<p style="color: red;">
...
<?php $__env->startSection('script'); ?>
	<script type="text/javascript" src="<?php echo e(asset('blog_assets/js/author.js')); ?>"></script>
<?php $__env->stopSection(); ?>
