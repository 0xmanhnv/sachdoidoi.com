			...
			<div class="col-lg-12">
	          ...
	          <div class="box box-widget widget-user">
	            ...
	            <div class="widget-user-header bg-black" style="background: url('<?php echo e($category->thumbnail); ?>') center center;">
	              <h3 class="widget-user-username"><?php echo e($category->name); ?></h3>
	              <h5 class="widget-user-desc"><?php echo e($category->description); ?></h5>
	            </div>
	            <div class="box-footer">
	              <div class="row">
	                ...
	                <div class="col-sm-4 border-right">
	                  <div class="description-block">
	                    <h5 class="description-header"><?php if(isset($countPost)): ?> <?php echo e($countPost); ?> <?php endif; ?></h5>
